...
# 最終更新: 2026-02-09 (Phase 15: jGrants wall_chat_ready改善 + データ品質向上)
# 管理者: モギモギ（関屋紘之）

## 1. データソース別状況サマリ

### 総計 (2026-02-09 Phase 15 最終更新)
| 指標 | 件数 | 割合 | Phase 14→15 変化 |
|------|------|------|-------------------|
...
| wall_chat_ready=1 | **20,345** | **91.4%** | **+165** (20,180→20,345) |
| wall_chat_ready=0 | **1,913** | 8.6% | -165 |
| searchable_count | **18,855** | - | **+164** (18,691→18,855) |
| ssot_accepting_count | **186** | - | ±0 |
| 受付中jGrants ready率 | **98.4%** (186/189) | - | **+84.1pp** (14.3%→98.4%) |
| Cron API動作確認 | **5本全稼働** | - | - |
