...
### 総計 (2026-02-09 Phase 13 最終更新)
| 指標 | 件数 | 割合 | Phase 12.2→13 変化 |
|------|------|------|-------------------|
| 総案件数 (subsidy_cache) | 22,258 | 100% | - |
| subsidy_canonical | 3,470 | - | - |
| 定点観測対象 (koubo_monitors) | 685 | 3.1% | - |
| 定点観測 active | **473** | 69.1% | +10 (463→473) |
| 定点観測 url_lost | **158** | 23.1% | ±0 |
| 定点観測 needs_manual | **54** | 7.9% | -10 (64→54) |
| PDF Coverage | **473/685** | **69.1%** | +1.5pp (67.6%→69.1%) |
| crawl_log 記録 | **695+** | 100%+ | Phase 13テスト分追加 |
| Cron API動作確認 | **5本全稼働** | - | バグ修正・テスト完了 |
