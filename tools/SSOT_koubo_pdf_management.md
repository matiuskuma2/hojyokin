...
# 最終更新: 2026-02-09 (Phase 12.2: 全件クロール完了 - 167件復旧)
# 管理者: モギモギ（関屋紘之）

## 1. データソース別状況サマリ

### 総計 (2026-02-09 Phase 12.2 最終更新)
| 指標 | 件数 | 割合 | Phase 12→12.2 変化 |
|------|------|------|-------------------|
| 総案件数 (subsidy_cache) | 22,258 | 100% | - |
| subsidy_canonical | 3,470 | - | - |
| 定点観測対象 (koubo_monitors) | 685 | 3.1% | - |
| 定点観測 active | **463** | 67.6% | +167 (296→463) |
| 定点観測 url_lost | **158** | 23.1% | -158 (316→158) |
| 定点観測 needs_manual | **64** | 9.3% | -9 (73→64) |
| PDF Coverage | **463/685** | **67.6%** | +24.4pp (43.2%→67.6%) |
| crawl_log 記録 | **685** | 100% | +685 (0→685) |
