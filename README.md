...
### 🎉 最新アップデート (v4.11.0) - 2026年度主要補助金データ一括投入
...
| **既存修復 5件** | ✅ | REAL-004〜008のdetail_json空白を全件修復（0件→全件完了） |
| **期限切れ非表示化 4件** | ✅ | ものづくりグローバル枠/成長分野/通常類型（22次受付終了）+事業再構築（最終回終了） |
| **searchable_count** | ✅ | 18,829 → 18,835（+6件） |
| **total_subsidies** | ✅ | 21,692 → 21,697（+5件） |
| **manual全件detail_jsonあり** | ✅ | 6件null → 0件null（全24件にdetail_json完備） |

**新規投入補助金（2026年度主要5制度）:**
| ID | 補助金名 | 上限額 | 申請締切 |
|----|----------|--------|---------|
| MONODUKURI-23 | ものづくり補助金 第23次公募 | 4,000万円 | 2026/5/8 |
| SHINJIGYO-03 | 新事業進出補助金 第3回公募 | 9,000万円 | 2026/3/26 |
| SEICHOU-KASOKU-02 | 成長加速化補助金 2次公募 | 5億円 | 2026/3/26 |
| JIGYOSHOKEI-MA-14 | 事業承継・M&A補助金 14次公募 | 2,000万円 | 2026/4/3 |
| SHINJIGYO-MONO-2026 | 新事業進出・ものづくり統合版（予告） | 9,000万円 | 2026年度後半 |
